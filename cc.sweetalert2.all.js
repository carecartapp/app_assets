...
var applyCustomClass = function applyCustomClass(elem, customClass, className) {
  ...
  toArray(elem.classList).forEach(function (className) {
    if (!(objectValues(ccswalClasses).indexOf(className) !== -1) && !(objectValues(iconTypes).indexOf(className) !== -1)) {
...
function getInput(content, inputType) {
  ...
  switch (inputType) {
    ...
    case 'textarea':
    case 'file':
      return getChildByClass(content, ccswalClasses[inputType]);

    case 'checkbox':
      return content.querySelector(".".concat(ccswalClasses.checkbox, " input"));

    case 'radio':
      return content.querySelector(".".concat(ccswalClasses.radio, " input:checked")) || content.querySelector(".".concat(ccswalClasses.radio, " input:first-child"));

    case 'range':
      return content.querySelector(".".concat(ccswalClasses.range, " input"));

    default:
      return getChildByClass(content, ccswalClasses.input);
  }
}
...
var getContainer = function getContainer() {
  return document.body.querySelector('.' + ccswalClasses.container);
};
...
var getPopup = function getPopup() {
  return elementByClass(ccswalClasses.popup);
};
var getIcons = function getIcons() {
  var popup = getPopup();
  return toArray(popup.querySelectorAll('.' + ccswalClasses.icon));
};
...
var getTitle = function getTitle() {
  return elementByClass(ccswalClasses.title);
};
var getContent = function getContent() {
  return elementByClass(ccswalClasses.content);
};
var getImage = function getImage() {
  return elementByClass(ccswalClasses.image);
};
var getProgressSteps = function getProgressSteps() {
  return elementByClass(ccswalClasses['progress-steps']);
};
var getValidationMessage = function getValidationMessage() {
  return elementByClass(ccswalClasses['validation-message']);
};
var getConfirmButton = function getConfirmButton() {
  return elementBySelector('.' + ccswalClasses.actions + ' .' + ccswalClasses.confirm);
};
var getCancelButton = function getCancelButton() {
  return elementBySelector('.' + ccswalClasses.actions + ' .' + ccswalClasses.cancel);
};
var getActions = function getActions() {
  return elementByClass(ccswalClasses.actions);
};
var getHeader = function getHeader() {
  return elementByClass(ccswalClasses.header);
};
var getFooter = function getFooter() {
  return elementByClass(ccswalClasses.footer);
};
var getCloseButton = function getCloseButton() {
  return elementByClass(ccswalClasses.close);
};
...
var isModal = function isModal() {
  return !isCCToast() && !document.body.classList.contains(ccswalClasses['no-backdrop']);
};
var isCCToast = function isCCToast() {
  return document.body.classList.contains(ccswalClasses['cctoast-shown']);
};
...
var sweetHTML = "\n <div aria-labelledby=\"".concat(ccswalClasses.title, "\" aria-describedby=\"").concat(ccswalClasses.content, "\" class=\"").concat(ccswalClasses.popup, "\" tabindex=\"-1\">\n   <div class=\"").concat(ccswalClasses.header, "\">\n     <ul class=\"").concat(ccswalClasses['progress-steps'], "\"></ul>\n     <div class=\"").concat(ccswalClasses.icon, " ").concat(iconTypes.error, "\">\n       <span class=\"ccswal2-x-mark\"><span class=\"ccswal2-x-mark-line-left\"></span><span class=\"ccswal2-x-mark-line-right\"></span></span>\n     </div>\n     <div class=\"").concat(ccswalClasses.icon, " ").concat(iconTypes.question, "\"></div>\n     <div class=\"").concat(ccswalClasses.icon, " ").concat(iconTypes.warning, "\"></div>\n     <div class=\"").concat(ccswalClasses.icon, " ").concat(iconTypes.info, "\"></div>\n     <div class=\"").concat(ccswalClasses.icon, " ").concat(iconTypes.success, "\">\n       <div class=\"ccswal2-success-circular-line-left\"></div>\n       <span class=\"ccswal2-success-line-tip\"></span> <span class=\"ccswal2-success-line-long\"></span>\n       <div class=\"ccswal2-success-ring\"></div> <div class=\"ccswal2-success-fix\"></div>\n       <div class=\"ccswal2-success-circular-line-right\"></div>\n     </div>\n     <img class=\"").concat(ccswalClasses.image, "\" />\n     <h2 class=\"").concat(ccswalClasses.title, "\" id=\"").concat(ccswalClasses.title, "\"></h2>\n     <button type=\"button\" class=\"").concat(ccswalClasses.close, "\">&times;</button>\n   </div>\n   <div class=\"").concat(ccswalClasses.content, "\">\n     <div id=\"").concat(ccswalClasses.content, "\"></div>\n     <input class=\"").concat(ccswalClasses.input, "\" />\n     <input type=\"file\" class=\"").concat(ccswalClasses.file, "\" />\n     <div class=\"").concat(ccswalClasses.range, "\">\n       <input type=\"range\" />\n       <output></output>\n     </div>\n     <select class=\"").concat(ccswalClasses.select, "\"></select>\n     <div class=\"").concat(ccswalClasses.radio, "\"></div>\n     <label for=\"").concat(ccswalClasses.checkbox, "\" class=\"").concat(ccswalClasses.checkbox, "\">\n       <input type=\"checkbox\" />\n       <span class=\"").concat(ccswalClasses.label, "\"></span>\n     </label>\n     <textarea class=\"").concat(ccswalClasses.textarea, "\"></textarea>\n     <div class=\"").concat(ccswalClasses['validation-message'], "\" id=\"").concat(ccswalClasses['validation-message'], "\"></div>\n   </div>\n   <div class=\"").concat(ccswalClasses.actions, "\">\n     <button type=\"button\" class=\"").concat(ccswalClasses.confirm, "\">OK</button>\n     <button type=\"button\" class=\"").concat(ccswalClasses.cancel, "\">Cancel</button>\n   </div>\n   <div class=\"").concat(ccswalClasses.footer, "\">\n   </div>\n </div>\n").replace(/(^|\n)\s*/g, '');
...
var resetOldContainer = function resetOldContainer() {
  ...
  removeClass([document.documentElement, document.body], [ccswalClasses['no-backdrop'], ccswalClasses['cctoast-shown'], ccswalClasses['has-column']]);
};

var oldInputVal; // IE11 workaround, see #1109 for details

var resetValidationMessage = function resetValidationMessage(e) {
  if (CCSwal.isVisible() && oldInputVal !== e.target.value) {
    CCSwal.resetValidationMessage();
  }
...
var addInputChangeListeners = function addInputChangeListeners() {
  ...
  var input = getChildByClass(content, ccswalClasses.input);
  var file = getChildByClass(content, ccswalClasses.file);
  var range = content.querySelector(".".concat(ccswalClasses.range, " input"));
  var rangeOutput = content.querySelector(".".concat(ccswalClasses.range, " output"));
  var select = getChildByClass(content, ccswalClasses.select);
  var checkbox = content.querySelector(".".concat(ccswalClasses.checkbox, " input"));
  var textarea = getChildByClass(content, ccswalClasses.textarea);
...
var setupAccessibility = function setupAccessibility(params) {
  var popup = getPopup();
  popup.setAttribute('role', params.cctoast ? 'alert' : 'dialog');
  popup.setAttribute('aria-live', params.cctoast ? 'polite' : 'assertive');
...
var setupRTL = function setupRTL(targetElement) {
  if (window.getComputedStyle(targetElement).direction === 'rtl') {
    addClass(getContainer(), ccswalClasses.rtl);
  }
};
/*
...
var init = function init(params) {
  ...
  container.className = ccswalClasses.container;
...
function handleButtonsStyling(confirmButton, cancelButton, params) {
  addClass([confirmButton, cancelButton], ccswalClasses.styled); // Buttons background colors
...
function renderButton(button, buttonType, params) {
  ...
  button.className = ccswalClasses[buttonType];
...
var renderActions = function renderActions(instance, params) {
  ...
  if (params.buttonsStyling) {
    ...
    removeClass([confirmButton, cancelButton], ccswalClasses.styled);
...
function handleBackdropParam(container, backdrop) {
  if (typeof backdrop === 'string') {
    ...
    addClass([document.documentElement, document.body], ccswalClasses['no-backdrop']);
  }
}

function handlePositionParam(container, position) {
  if (position in ccswalClasses) {
    addClass(container, ccswalClasses[position]);
  } else {
    warn('The "position" parameter is not valid, defaulting to "center"');
    addClass(container, ccswalClasses.center);
  }
}
...
function handleGrowParam(container, grow) {
  if (grow && typeof grow === 'string') {
    ...
    if (growClass in ccswalClasses) {
      addClass(container, ccswalClasses[growClass]);
    }
  }
}
...
/**
 * This module containts `WeakMap`s for each effectively-"private  property" that a `CCSwal` has.
...
var renderInput = function renderInput(instance, params) {
  ...
  for (var i = 0; i < inputTypes.length; i++) {
    var inputClass = ccswalClasses[inputTypes[i]];
...
renderInputType.text = renderInputType.email = renderInputType.password = renderInputType.number = renderInputType.tel = renderInputType.url = function (params) {
  var input = getChildByClass(getContent(), ccswalClasses.input);
...
renderInputType.file = function (params) {
  var input = getChildByClass(getContent(), ccswalClasses.file);
  setInputPlaceholder(input, params);
  input.type = params.input;
  return input;
};
...
renderInputType.range = function (params) {
  var range = getChildByClass(getContent(), ccswalClasses.range);
...
renderInputType.select = function (params) {
  var select = getChildByClass(getContent(), ccswalClasses.select);
  select.innerHTML = '';
...
renderInputType.radio = function () {
  var radio = getChildByClass(getContent(), ccswalClasses.radio);
  radio.innerHTML = '';
  return radio;
};

renderInputType.checkbox = function (params) {
  var checkbox = getChildByClass(getContent(), ccswalClasses.checkbox);
  var checkboxInput = getInput(getContent(), 'checkbox');
  checkboxInput.type = 'checkbox';
  checkboxInput.value = 1;
  checkboxInput.id = ccswalClasses.checkbox;
...
renderInputType.textarea = function (params) {
  var textarea = getChildByClass(getContent(), ccswalClasses.textarea);
...
var renderContent = function renderContent(instance, params) {
  var content = getContent().querySelector('#' + ccswalClasses.content); // Content as HTML
...
var renderIcon = function renderIcon(instance, params) {
  ...
  if (Object.keys(iconTypes).indexOf(params.type) !== -1) {
    var icon = elementBySelector(".".concat(ccswalClasses.icon, ".").concat(iconTypes[params.type]));
    show(icon); // Custom class

    applyCustomClass(icon, params.customClass, 'icon'); // Animate icon

    toggleClass(icon, "ccswal2-animate-".concat(params.type, "-icon"), params.animation);
  } else {
...
var adjustSuccessIconBackgoundColor = function adjustSuccessIconBackgoundColor() {
  ...
  var successIconParts = popup.querySelectorAll('[class^=ccswal2-success-circular-line], .ccswal2-success-fix');
...
var renderImage = function renderImage(instance, params) {
  ...
  image.className = ccswalClasses.image;
...
var createStepElement = function createStepElement(step) {
  ...
  addClass(stepEl, ccswalClasses['progress-step']);
...
var createLineElement = function createLineElement(params) {
  ...
  addClass(lineEl, ccswalClasses['progress-step-line']);
...
var renderProgressSteps = function renderProgressSteps(instance, params) {
  ...
  var currentProgressStep = parseInt(params.currentProgressStep === null ? CCSwal.getQueueStep() : params.currentProgressStep);
  ...
  params.progressSteps.forEach(function (step, index) {
    ...
    if (index === currentProgressStep) {
      addClass(stepEl, ccswalClasses['active-progress-step']);
    }
...
var renderPopup = function renderPopup(instance, params) {
  ...
  popup.className = ccswalClasses.popup;

  if (params.cctoast) {
    addClass([document.documentElement, document.body], ccswalClasses['cctoast-shown']);
    addClass(popup, ccswalClasses.cctoast);
  } else {
    addClass(popup, ccswalClasses.modal);
  } // Custom class
  ...
  toggleClass(popup, ccswalClasses.noanimation, !params.animation);
};
...
function fire() {
  ...
  return _construct(CCSwal, args);
}

/**
 * Returns an extended version of `CCSwal` containing `params` as defaults.
 * Useful for reusing CCSwal configuration.
 *
 * For example:
 *
 * Before:
 * const textPromptOptions = { input: 'text', showCancelButton: true }
 * const {value: firstName} = await CCSwal.fire({ ...textPromptOptions, title: 'What is your first name?' })
 * const {value: lastName} = await CCSwal.fire({ ...textPromptOptions, title: 'What is your last name?' })
 *
 * After:
 * const TextPrompt = CCSwal.mixin({ input: 'text', showCancelButton: true })
...
function mixin(mixinParams) {
  ...
  /*#__PURE__*/
  function (_this) {
    _inherits(MixinCCSwal, _this);

    function MixinCCSwal() {
      _classCallCheck(this, MixinCCSwal);

      return _possibleConstructorReturn(this, _getPrototypeOf(MixinCCSwal).apply(this, arguments));
    }

    _createClass(MixinCCSwal, [{
      key: "_main",
      value: function _main(params) {
        return _get(_getPrototypeOf(MixinCCSwal.prototype), "_main", this).call(this, _extends({}, mixinParams, params));
      }
    }]);
...
var queue = function queue(steps) {
  ...
  var resetAndResolve = function resetAndResolve(resolve, value) {
    currentSteps = [];
    document.body.removeAttribute('data-ccswal2-queue-step');
    resolve(value);
  };
  ...
  return new Promise(function (resolve) {
    (function step(i, callback) {
      if (i < currentSteps.length) {
        document.body.setAttribute('data-ccswal2-queue-step', i);
        CCSwal.fire(currentSteps[i]).then(function (result) {
...
var getQueueStep = function getQueueStep() {
  return document.body.getAttribute('data-ccswal2-queue-step');
};
/*
...
var showLoading = function showLoading() {
  ...
  show(actions);
  show(confirmButton);
  addClass([popup, actions], ccswalClasses.loading);
...
var cctoastIncompatibleParams = ['allowOutsideClick', 'allowEnterKey', 'backdrop', 'focusConfirm', 'focusCancel', 'heightAuto', 'keydownListenerCapture'];
/**
 * Is valid parameter
...
/**
 * Is valid parameter for CCSwal.update() method
 * @param {String} paramName
 */
...
var checkIfCCToastParamIsValid = function checkIfCCToastParamIsValid(param) {
  if (cctoastIncompatibleParams.indexOf(param) !== -1) {
    warn("The parameter \"".concat(param, "\" is incompatible with cctoasts"));
  }
};
...
var showWarningsForParams = function showWarningsForParams(params) {
  for (var param in params) {
    ...
    if (params.cctoast) {
      checkIfCCToastParamIsValid(param);
    }
...
function hideLoading() {
  ...
  removeClass([domCache.popup, domCache.actions], ccswalClasses.loading);
...
var iOSfix = function iOSfix() {
  ...
  if (iOS && !hasClass(document.body, ccswalClasses.iosfix)) {
    var offset = document.body.scrollTop;
    document.body.style.top = offset * -1 + 'px';
    addClass(document.body, ccswalClasses.iosfix);
  }
};
/* istanbul ignore next */

var undoIOSfix = function undoIOSfix() {
  if (hasClass(document.body, ccswalClasses.iosfix)) {
    var offset = parseInt(document.body.style.top, 10);
    removeClass(document.body, ccswalClasses.iosfix);
 ...
 */
var privateMethods = {
  ccswalPromiseResolve: new WeakMap()
};
...
function removePopupAndResetState(container, onAfterClose) {
  ...
  removeClass([document.documentElement, document.body], [ccswalClasses.shown, ccswalClasses['height-auto'], ccswalClasses['no-backdrop'], ccswalClasses['cctoast-shown'], ccswalClasses['cctoast-column']]);
...
function ccswalCloseEventFinished(popup, container, onAfterClose) {
  popup.removeEventListener(animationEndEvent, ccswalCloseEventFinished);

  if (hasClass(popup, ccswalClasses.hide)) {
...
function close(resolveValue) {
  ...
  var popup = getPopup();
  var innerParams = privateProps.innerParams.get(this);
  var ccswalPromiseResolve = privateMethods.ccswalPromiseResolve.get(this);
  ...
  removeClass(popup, ccswalClasses.show);
  addClass(popup, ccswalClasses.hide); // If animation is supported, animate

  if (animationEndEvent && !hasClass(popup, ccswalClasses.noanimation)) {
    popup.addEventListener(animationEndEvent, ccswalCloseEventFinished.bind(null, popup, container, onAfterClose));
  } else {
    // Otherwise, remove immediately
    removePopupAndResetState(container, onAfterClose);
  } // Resolve CCSwal promise


  ccswalPromiseResolve(resolveValue || {});
}
...
function enableConfirmButton() {
  warnAboutDepreation('CCSwal.disableConfirmButton()', "CCSwal.getConfirmButton().removeAttribute('disabled')");
  setButtonsDisabled(this, ['confirmButton'], false);
} // @deprecated

function disableConfirmButton() {
  warnAboutDepreation('CCSwal.enableConfirmButton()', "CCSwal.getConfirmButton().setAttribute('disabled', '')");
...
function showValidationMessage(error) {
  ...
  if (input) {
    ...
    input.setAttribute('aria-describedBy', ccswalClasses['validation-message']);
    focusInput(input);
    addClass(input, ccswalClasses.inputerror);
  }
...
function resetValidationMessage$1() {
  ...
  if (input) {
    ...
    removeClass(input, ccswalClasses.inputerror);
  }
}

function getProgressSteps$1() {
  warnAboutDepreation('CCSwal.getProgressSteps()', "const ccswalInstance = CCSwal.fire({progressSteps: ['1', '2', '3']}); const progressSteps = ccswalInstance.params.progressSteps");
  var innerParams = privateProps.innerParams.get(this);
  return innerParams.progressSteps;
}
function setProgressSteps(progressSteps) {
  warnAboutDepreation('CCSwal.setProgressSteps()', 'CCSwal.update()');
  var innerParams = privateProps.innerParams.get(this);
...
function setParameters(params) {
  ...
  // before popup (re)initialization, so it'll be possible to check CCSwal.isVisible()
...
function ccswalOpenAnimationFinished(popup, container) {
  popup.removeEventListener(animationEndEvent, ccswalOpenAnimationFinished);
...
var openPopup = function openPopup(params) {
  ...
  if (params.animation) {
    addClass(popup, ccswalClasses.show);
    addClass(container, ccswalClasses.fade);
  }
  ...
  if (animationEndEvent && !hasClass(popup, ccswalClasses.noanimation)) {
    ...
    popup.addEventListener(animationEndEvent, ccswalOpenAnimationFinished.bind(null, popup, container));
  } else {
    container.style.overflowY = 'auto';
  }

  addClass([document.documentElement, document.body, container], ccswalClasses.shown);

  if (params.heightAuto && params.backdrop && !params.cctoast) {
    addClass([document.documentElement, document.body], ccswalClasses['height-auto']);
  }
  ...
  if (!isCCToast() && !globalState.previousActiveElement) {
...
var populateInputOptions = {
  ...
  radio: function radio(content, inputOptions, params) {
    var radio = getChildByClass(content, ccswalClasses.radio);
    inputOptions.forEach(function (inputOption) {
      ...
      radioInput.name = ccswalClasses.radio;
      ...
      label.className = ccswalClasses.label;
...
function _main(userParams) {
  ...
  return new Promise(function (resolve) {
    ...
    privateMethods.ccswalPromiseResolve.set(_this, resolve); // Close on timer
    ...
    if (innerParams.cctoast && (innerParams.input || innerParams.footer || innerParams.showCloseButton)) {
      addClass(document.body, ccswalClasses['cctoast-column']);
    } else {
      removeClass(document.body, ccswalClasses['cctoast-column']);
...
function update(params) {
  ...
  Object.keys(params).forEach(function (param) {
    if (CCSwal.isUpdatableParameter(param)) {
